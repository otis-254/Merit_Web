            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 md:gap-12 items-center justify-items-center">
              {[
                ...
                <motion.div
                  ...
                  className="group w-full max-w-[160px] aspect-square flex items-center justify-center p-4 bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-md transition-all duration-300"
                >
                  <img
                    src={logo}
                    alt="Brand Logo"
